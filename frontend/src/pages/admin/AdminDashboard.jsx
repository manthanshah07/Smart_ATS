  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground text-sm">Platform metrics, user management, and moderation controls.</p>
      </div>
      ...
      <div className="grid md:grid-cols-4 gap-6">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">APIs and AI Services</p>
          </CardContent>
        </Card>
      </div>
    </div>
